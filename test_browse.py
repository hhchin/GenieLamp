...
class Browser(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        self.bt_back.setIcon(QtGui.QIcon().fromTheme("go-previous       self.bt_ahead.setIcon(QtGui.QIcon().fromTheme("go-next        self.horizontalLayout.addWidget(self.bt_back)
