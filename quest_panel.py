...
class QuestPanel(QtGui.QDockWidget):
    def __init__(self, parent=None):
        """Constructor."""
        super(QuestPanel, self).__init__(parent)
	...
	self.centralwidget = QtGui.QWidget(self)
        ...
        self.setTitleBarWidget(QtGui.QLabel(u'Genie Quest View'))
    def browse(self):
        """
